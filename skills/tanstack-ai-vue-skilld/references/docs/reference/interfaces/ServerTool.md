...
Defined in: packages/typescript/ai/src/activities/chat/tools/tool-definition.ts:13
...
Defined in: packages/typescript/ai/src/activities/chat/tools/tool-definition.ts:18
