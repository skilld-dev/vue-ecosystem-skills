...
## How Does Reactivity Work in Unhead?
...
Behind the scenes, Unhead uses Vue's provide/inject system for head instance management. When we call `useHead()`{lang="ts"}, it uses the Vue inject function to get the Unhead instance attached to the Vue application:
...
### How Does Reactivity Differ Between Client and Server?
...
### Can I Use useHead Inside a Watcher?
...
### How Can I Optimize Frequent Component Mounts?
...
## Does Nuxt Handle This Differently?
