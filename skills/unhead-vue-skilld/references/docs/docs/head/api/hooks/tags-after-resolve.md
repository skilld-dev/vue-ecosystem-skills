...
meta:
  "og:description": "Final hook before rendering. Perform security checks, reorder tags for performance, and process content before output."
...
This is the last hook in the tag resolution chain. It runs after `tags:resolve`.
...
### [Final Security Checks](#final-security-checks)
...
### [Final Content Processing](#final-content-processing)
