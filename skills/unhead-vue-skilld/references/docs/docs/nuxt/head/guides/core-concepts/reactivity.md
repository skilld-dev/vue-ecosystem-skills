...
meta:
  "og:description": "Use refs and computed with useHead() in Nuxt. Handle async context with injectHead() and effectScope(). Automatic reactivity for head tags."
  "og:title": "Vue Reactivity and Async Context · Unhead"
  description: "Use refs and computed with useHead() in Nuxt. Handle async context with injectHead() and effectScope(). Automatic reactivity for head tags."
---
...
Behind the scenes, Unhead is attached to the Nuxt instance. When we call `useHead()`, it accesses the global Nuxt instance and uses the Unhead instance from it.
...
### [What Is the Difference Between Client and Server Reactivity?](#what-is-the-difference-between-client-and-server-reactivity)
...
### [Can I Use Top Level Await?](#can-i-use-top-level-await)
...
### [How Do I Use effectScope for Async Operations?](#how-do-i-use-effectscope-for-async-operations)
...
### [When Should I Use injectHead?](#when-should-i-use-injecthead)
    ...
    script: [
      {
        ...
        textContent: analyticsData.scriptContent
      }
    ]
  }, { head })
})
...
### [What Is the Best Way to Handle Async Head Updates?](#what-is-the-best-way-to-handle-async-head-updates)
...
#### [How Do I Use Head with Pinia?](#how-do-i-use-head-with-pinia)
...
### [Can I Call useHead Inside a Watcher?](#can-i-call-usehead-inside-a-watcher)
...
### [How Do I Optimize Frequent Component Mounts?](#how-do-i-optimize-frequent-component-mounts)
...
export default {
  setup() {
    ...
    // https://unhead.unjs.io/docs/head/api/composables/use-seo-meta
    useSeoMeta({
