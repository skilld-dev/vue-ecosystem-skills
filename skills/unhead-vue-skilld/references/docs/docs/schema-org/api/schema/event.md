---
title: "Event Schema · Unhead"
meta:
  "og:description": "Use defineEvent() to add Event structured data to your pages. Enable rich results for concerts, conferences, and meetups with dates, venues, and ticket info."
  "og:title": "Event Schema · Unhead"
...
- **Schema.org Event**
- **Event Schema Markup - Google Search Central**
...
- **Person** - Event performer
- **LocalBusiness** - Event venue
