---
title: "Service Schema · Unhead"
meta:
  "og:description": "Use defineService() to add Service structured data. Display service offerings with pricing, provider info, and reviews in search results."
  "og:title": "Service Schema · Unhead"
...
- **provider** `NodeRelations<Person | Organization | string>`Who provides the service. Resolves to **Person** or **Organization**.
...
- **LocalBusiness** - Service location
