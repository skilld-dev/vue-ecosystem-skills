...
meta:
  "og:description": "Add HowTo structured data with defineHowTo(). Enable step-by-step rich snippets with images, supplies, and time estimates."
...
For time durations, use **ISO 8601 duration format**. For example, "PT30M" represents 30 minutes, "PT2H30M" represents 2 hours and 30 minutes.
...
6. **Test in Google's Rich Results Test**: Validate your markup using **Google's Rich Results Test**.
