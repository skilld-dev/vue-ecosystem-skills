---
title: "Install Unhead on TypeScript Projects · Unhead"
meta:
  "og:description": "Set up Unhead with pure TypeScript. Framework-agnostic head management with createHead() and useHead() for SSR and client-side apps."
  "og:title": "Install Unhead on TypeScript Projects · Unhead"
