...
meta:
  "og:description": "Add Schema.org to Vue apps with @unhead/schema-org. Setup defineWebSite(), defineWebPage() for Google Rich Results."
  "og:title": "Install Unhead Schema.org · Unhead"
  description: "Add Schema.org to Vue apps with @unhead/schema-org. Setup defineWebSite(), defineWebPage() for Google Rich Results."
---
...
Your Vue app is now serving basic Schema.org, congrats!
