...
JetBrains Marketplace // GitHub Repository

## Sherlock – i18n inspector (VS Code extension)

Sherlock is a VS Code extension that helps you to extract, edit & inspect your i18n keys in your codebase. It is available in the VS Code Marketplace.
